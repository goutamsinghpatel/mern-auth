    ...
    return(
       ...
       {/* email otp send */}
        ...
        <div className="mb-4 flex  items-center gap-3   w-full px-5 py-2.5  rounded-full bg-[#333A5C]">
            ...
            <input type="email" placeholder="enter you email"  value={email} onChange={(e)=>SetEmail(e.target.value)} required className="bg-transparent outline-none text-white"/>
        </div>
...
{isOtpSubmited && isEmailSent &&
  <form onSubmit={onSubmitNewPassword} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96  text-sm">
        ...
        <div className="mb-4 flex  items-center gap-3   w-full px-5 py-2.5  rounded-full bg-[#333A5C]">
            <img src={assets.mail_icon } className="w-3 h-3"/>
            <input type="password" placeholder="enter you new password"  value={newPassword} onChange={(e)=>SetNewPassword(e.target.value)} required className="bg-transparent outline-none text-white"/>
        </div>
        <button className="w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3 ">Submit</button>
